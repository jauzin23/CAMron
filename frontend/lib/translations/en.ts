export const en = {
  ...
  restricted: {
    ...
    titleNew: "Add Camera Restricted",
  },
  wizard: {
    identity: "Identity",
    flash: "Installation",
  ...
  dashboard: {
    ...
    description: "Manage and monitor your cameras.",
  ...
  live: {
    ...
    colorModeNightVision: "Night Vision",
    colorModeAmber: "Amber",
    colorModeThermal: "Thermal",
